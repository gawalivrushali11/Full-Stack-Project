...
const Search = () => {
    ...
    const filterProductList=productList.filter((p)=>p.pdescription.toLowerCase()===sq || p.pname.toLowerCase()===sq || p.pmanufacturer.toLowerCase()===sq)
   console.log("Filter",filterProductList)
